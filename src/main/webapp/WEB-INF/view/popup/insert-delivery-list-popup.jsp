...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btn_excelDownload').click (function () {
            $('#frmDefault').attr ('action', '/file/sampleExcelDown/delivery').submit();
        });
        ...
        $('#btn_submit').bind("click", function () {
            ...
            if(confirm("운송장 번호를 일괄 등록 하시겠습니까?")){
                var formData = new FormData($('#frmDefault')[0]);
                $.ajax({
                    type : "POST",
                    url : "insert-delivery-list",
                    processData: false,
                    contentType: false,
                    dataType : "json",
                    data: formData,
    ...
    function logExcelDownlaod () {
        ...
        // 엑셀 다운로드시 로딩바 생성함.
        var DOWNLOAD_URL = "excel/insert-delivery-excel-log";
