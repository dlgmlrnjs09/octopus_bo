                                            ...
                                            <div id="option_input_wrap">
                                                ...
                                                <div id="convert-option-list-wrap">
                                                    <div class="input-box text" style="width:100%">
                                                        <button type="button" id="convert-option-list-btn" class="common-btn" aria-label="title" onclick="location.href='#none'" style="width: 100%; height: 5px"><span style="font-size: 15px;">옵션목록으로 적용 ▼</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
